...
final class SecretSantaCoreVladTest extends TestCase {

	public static function setUpBeforeClass() {
		// Load the class to be tested.
		require_once dirname( dirname( __DIR__ ) ) . '/vlad/class-SecretSantaCore.php';
	}
	...
	public function testInvalidAddUsers() {
		$reflection = new ReflectionClass( 'SecretSantaCoreVlad' );
